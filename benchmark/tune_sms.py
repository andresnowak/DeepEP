...
from https://github.com/NousResearch/torchtitan/blob/dev-updated-again/scripts/deepep/torchtitan_deepep_tune/tune_singlenode.py
"""
...
def main():
    ...
    if local_rank == 0:
        ...
        print("  Hardware: H100 (~132 SMs per GPU)")
        print("=" * 100)

    # Test different num_sms values
    # Even values work best due to num_channels = num_sms / 2
    # H100 has ~132 SMs, so testing up to ~100 SMs is reasonable
    num_sms_range = [8, 12, 16, 20, 24, 28, 32, 40, 48, 56, 64]
